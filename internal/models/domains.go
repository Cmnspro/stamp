...
var DomainWhere = struct {
	...
	Domain:    whereHelperstring{field: "\"domains\".\"domain\""},
	ParentID:  whereHelpernull_String{field: "\"domains\".\"parent_id\""},
...
var (
	domainAllColumns            = []string{"id", "domain", "parent_id", "created_at", "updated_at"}
	domainColumnsWithoutDefault = []string{"domain", "parent_id", "created_at", "updated_at"}
...
func (o *Domain) DomainStamps(mods ...qm.QueryMod) domainStampQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"domain_stamps\".\"domain_id\"=?", o.ID),
	)
...
func (domainL) LoadDomainStamps(ctx context.Context, e boil.ContextExecutor, singular bool, maybeDomain interface{}, mods queries.Applicator) error {
	var slice []*Domain
	var object *Domain
	...
	query := NewQuery(
		...
		qm.WhereIn(`domain_stamps.domain_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Domain) AddDomainStamps(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*DomainStamp) error {
	var err error
